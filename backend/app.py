...
AZURE_COGNITIVE_SEARCH_ENDPOINT = f"https://{AZURE_SEARCH_SERVICE}.search.azure.cn"
#AZURE_COGNITIVE_SEARCH_ENDPOINT = f"https://{AZURE_SEARCH_SERVICE}.search.windows.net
AZURE_BLOB_STORAGE_ACCOUNT_ENDPOINT = f"https://{AZURE_BLOB_STORAGE_ACCOUNT}.blob.core.chinacloudapi.cn"
...
ask_approaches = {
    ...
    "rda": ReadDecomposeAsk(search_client, AZURE_OPENAI_GPT_DEPLOYMENT, KB_FIELDS_SOURCEPAGE, KB_FIELDS_CONTENT, AZURE_OPENAI_API_KEY_SOUTH_CENTRAL_US, AZURE_OPENAI_BASE),
    "bing": BingSearchApproach(search_client, AZURE_OPENAI_CHATGPT_DEPLOYMENT, KB_FIELDS_SOURCEPAGE, KB_FIELDS_SOURCE_PATH, AZURE_BING_SEARCH_SUBSCRIPTION_KEY, AZURE_BING_SEARCH_ENDPOINT, AZURE_OPENAI_API_KEY_SOUTH_CENTRAL_US, AZURE_OPENAI_BASE)
}
