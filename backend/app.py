...
ask_approaches = {
    ...
    "rda": ReadDecomposeAsk(search_client, AZURE_OPENAI_GPT_DEPLOYMENT, KB_FIELDS_SOURCEPAGE, KB_FIELDS_CONTENT, AZURE_OPENAI_API_KEY_SOUTH_CENTRAL_US, AZURE_OPENAI_BASE, AZURE_BING_SEARCH_SUBSCRIPTION_KEY, AZURE_BING_SEARCH_ENDPOINT, KB_FIELDS_SOURCE_PATH),
}
